...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--load_checkpoint", default=None, help="/path/to/checkpoints.pth"
    )
    ...
    print("model config: {}".format(mconf))
    print("train_dataset.vocab_size: {}".format(train_dataset.vocab_size))
    print("train_dataset.max_length: {}".format(train_dataset.max_length))
    print("args.n_layer: {}".format(args.n_layer))
    print("args.n_head: {}".format(args.n_head))
    print("args.n_embd: {}".format(args.n_embd))

    # model = GPT(mconf).to(device)
    # load checkpoint from pth file
    if args.load_checkpoint is not None:
        model.load_state_dict(torch.load(args.load_checkpoint))
        print("Loaded checkpoint from {}".format(args.load_checkpoint))
